<template>
    <div class="card">
        ...
        <p class="text-lg mb-4">
            MotiTasking is an application template for Vue based on the <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue
            projects. To get started, clone the <a href="https://github.com/your-org/moti-tasking" class="font-medium text-primary hover:underline">repository</a> from GitHub and install the dependencies with npm or yarn.
        </p>
        <pre class="app-code">
<code>git clone https://github.com/your-org/moti-tasking
npm install
npm run dev</code></pre>
        ...
        <div class="font-semibold text-xl mb-4">Add MotiTasking to a Nuxt Project</div>
        <p class="text-lg mb-4">To get started, create a Nuxt project.</p>
        <pre class="app-code">
<code>npx nuxi@latest init motitasking-nuxt</code></pre>
